...
function OeeUtils() {
    ...
    async function getOeeImpl(fromTs, toTs, limit, attr, deviceId, applId, devTz, tenantId) {
        let db = await DB.Get();
        let responseObj = {};
        let resultObj = {};
    ...
    async function getOeeMericsImpl(fromTs, toTs, deviceId) {
        let db = await DB.Get();
        let shiftfilter = {}
    ...
    async function getOeeDetailsImpl(fromTs, toTs, limit, attr, deviceId, applId) {
        let db = await DB.Get();
        let responseObj = {};
    ...
    return {
        getOee: getOeeImpl,
        getOeeMerics: getOeeMericsImpl,
        getOeeDetails: getOeeDetailsImpl
    }
}

module.exports = OeeUtils();